...
<main style="height: 100vh;">
    ...
    <article>
        <article>
            @php
//            todo bool
                $emails = app('App\Http\Controllers\mailbox_controller')->get_email_with_category(Auth::user()->id,app('App\Http\Controllers\mailbox_controller')->get_id_category('Starred')[0]->id);
    //            dd(Auth::user()->id);
            if (count($emails) == 0) {
