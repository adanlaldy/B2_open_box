...
<main>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light color3 p-0">
        <div class="container-fluid d-flex justify-content-between align-items-center container-fluid-custom color3 p-0">
            <h1 class="form-inline my-lg-0 mx-auto text-center">@lang('index.sent')</h1>
        </div>
    </nav>
    <!-- Sidebar -->
    <div class="sidebar color1">
        <nav>
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li><a class="nav-link color1 margin-20" href="/{{ Session::get('locale') }}/sents"><i class="fi fi-ss-paper-plane"></i>@lang('index.sent')</a></li>
