...
<main>
    ...
    <div class="sidebar">
        <nav>
            <a class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none margin-20" href="/inbox">Open Box {{ Auth::user()->email }}</a>
            <hr class="bar-menu">
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li><a class="nav-link active margin-20" href="/en/sents">@lang('index.sent')</a></li>
