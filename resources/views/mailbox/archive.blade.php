...
<div class="sidebar">
    <nav>
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li><a class="nav-link active margin-20" href="/archive">Archives</a></li>
...
<div class="content">
    <?php
    $inbox_emails = app('App\Http\Controllers\mailbox_controller')->get_email_with_category(Auth::user()->id, app('App\Http\Controllers\mailbox_controller')->get_category_id_by_name('archive'));
    if (empty($inbox_emails)) {
        echo '<div class="picture">';
        echo '<img class="picture center" src="http://127.0.0.1:8000/images/mail.png" alt="img">';
        echo '<h2 class="text-center">Aucun message archiver</h2>';
        echo '</div>';
    }
    ?>
