...
<head>
    ...
    <title>@lang('index.all_emails') - Open Box</title>
...
<main>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light color3 p-0">
        <div class="container-fluid d-flex justify-content-between align-items-center container-fluid-custom color3 p-0">
            <h1 class="form-inline my-2 my-lg-0 margin-50">@lang('index.all_mail')</h1>
        </div>
    </nav>
    <!-- Sidebar -->
    <div class="sidebar color1">
        <nav>
            <a class="d-flex align-items-center mb-3 mb-md-0 me-md-auto nav-link margin-20" href="/{{ Session::get('locale', app()->getLocale()) }}/inbox">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item d-lg-none"><a class="nav-link color1" href="/{{ Session::get('locale', app()->getLocale()) }}/offers"><i class="fi fi-sr-wallet"></i>@lang('index.subscription')</a></li>
                ...
                <li><a class="nav-link color1 margin-20" href="/{{ Session::get('locale', app()->getLocale()) }}/all-emails"><i class="fi fi-sr-apps"></i>@lang('index.all_mail')</a></li>
                <hr class="bar-menu nav-item d-lg-none">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="toEmail" type="email" class="form-control" id="to" value="{{ $email->to }}">
                            </div>
                            <div class="form-group">
                                <label for="cc">@lang('index.cc') :</label>
                                <input name="ccEmail" type="email" class="form-control" id="cc" value="{{ $email->cc }}">
                            </div>
                            <div class="form-group">
                                <label for="subject">@lang('index.subject') :</label>
                                <input name="subjectEmail" type="text" class="form-control" id="subject" value="{{ $email->subject }}">
                            </div>
                            <div class="form-group">
                                <label for="body">@lang('index.message') :</label>
                                <textarea name="bodyEmail" class="form-control" id="body">{{ $email->body }}</textarea>
                            </div>
                        </div>
                    </div>
                </dialog>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-rb6D08fP6uxg5lIH13XK4nY6MjBeTzKfZ5MDZtRtmN6pb7iOQVdWlPQjcVFGF4p7" crossorigin="anonymous"></script>
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const dialogEmailDetails = document.querySelector('#dialogEmailDetails');
        const closeEmailDetails = document.querySelector('#closeEmailDetails');

        emailDetailsButtons.forEach(button => {
