...
<main>
    ...
    <div class="sidebar">
        <nav>
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/inbox">@lang('index.inbox')</a></li>
                ...
                <li><a class="nav-link active margin-20" href="/all-emails">@lang('index.all_mail')</a></li>
                <hr class="bar-menu nav-item d-lg-none">
    ...
    <button class="btn btn-primary mt-3 static">@lang('index.send')</button>
