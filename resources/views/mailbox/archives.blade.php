    ...
    <div class="sidebar color1">
        ...
        <nav>
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li><a class="nav-link color1 margin-20" href="/{{ Session::get('locale') }}/archives"><i class="fi fi-sr-bookmark"></i>@lang('index.archive')</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col w-auto p-0">
                        ...
                        <form action="/remove-from-archives" method="post">
                            @csrf
                            <input type="hidden" name="emailId" value="{{ $email->id }}">
                            <button type="submit" class="btn btn-outline-info">@lang('index.remove_archived')</button>
                        </form>
