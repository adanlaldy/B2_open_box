...
<head>
    ...
    <title>@lang('index.archive_title') - Open Box</title>
...
<main>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light color3 p-0">
        <div class="container-fluid d-flex justify-content-between align-items-center container-fluid-custom color3 p-0">
            <h1 class="form-inline my-2 my-lg-0 margin-50">@lang('index.archive_title')</h1>
        </div>
    </nav>
    <!-- Sidebar -->
    <div class="sidebar color1">
        <nav>
            <a class="d-flex align-items-center mb-3 mb-md-0 me-md-auto nav-link margin-20" href="/en/inbox">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item d-lg-none"><a class="nav-link color1 margin-20" href="/en/offers"><i class="fi fi-sr-wallet"></i>@lang('index.subscription')</a></li>
                ...
                <li><a class="nav-link margin-20 color1" href="/en/archives"><i class="fi fi-sr-bookmark"></i>@lang('index.archive')</a></li>
    ...
    <article class="content">
        <ul>
            @forelse($archivedsEmails as $email)
                <div class="row">
                    <div class="col p-0">
                    ...
                    <div class="col w-auto p-0">
                        ...
                        <form action="/remove-from-archives" method="post">
                            @csrf
                            <input type="hidden" name="email_id" value="{{ $email->id }}">
