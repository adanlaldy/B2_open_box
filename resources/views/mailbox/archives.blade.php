...
<main>
    ...
    <div class="sidebar">
        <nav>
            <a class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none margin-20" href="/index">@lang('index.open_box') <?php echo Auth::user()->email; ?></a>
            <hr class="bar-menu">
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/en/index">@lang('index.index')</a></li>
                ...
                <li><a class="nav-link active margin-20" href="/en/archives">@lang('index.archive')</a></li>
