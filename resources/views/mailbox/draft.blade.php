...
<main style="height: 100vh;">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary h-100" style="width: 280px; float: left;">
        <nav>
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item"><a class="nav-link link-body-emphasis" href="/inbox">Boîte de réception</a></li>
                <li><a class="nav-link active" href="/draft">Brouillons</a></li>
    ...
    <article>
        <article>
            @php
                $emails = app('App\Http\Controllers\mailbox_controller')->get_email_with_category(Auth::user()->id,app('App\Http\Controllers\mailbox_controller')->get_id_category('draft')[0]->id);
            //            dd(Auth::user()->id);
                    if (count($emails) == 0) {
